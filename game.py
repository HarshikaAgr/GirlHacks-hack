goodchoices = ["Head straight towards the open doors", "walk through the doors", "Rest on the bench nearby.", "Resonate with the light of disco.", "Seek guidance from the adventurer's guild", "Set off immediately towards the temple", "Take the old wizard's advice", "Listen to the signs", "Follow the pathway to the familiar-looking temple."]
...
print("--------------------------------\nGAME START\n--------------------------------")
print("Detective " + name + ", thanks for coming. As you can see, there's been a case here and we need your help. You look around the surroundings and see that the dance floor is scarce and the usual disco ball is missing from its place. Suddenly, there is a loud commotion in the distance. You look around and see another crowd on one side of the room. On the other side, you see a door that is slightly ajar, with rays of purple light shining through.")
